...
from misc.utils import ReplayBuffer, ConvolutionalQNetwork
...
class ConvolutionalDQNAgent():
    def __init__(self,
        ...
        # both nets
        self.policy_net: ConvolutionalQNetwork = ConvolutionalQNetwork(self.state_dim, self.n_actions).to(self.device)
        self.target_net: ConvolutionalQNetwork = ConvolutionalQNetwork(self.state_dim, self.n_actions).to(self.device)
